  ...
  try {
    if (ls_nfl_games[ls_player[pid].nfl_team].secs_left === 0)
      if (ls_player[pid] === undefined || isNaN(ls_player[pid].points))
        if (ls_projections['pid_' + pid] === undefined) return ({
          "pace": 0,
          "points": 0,
          "projected": 0,
    ...
    else if (ls_projections['pid_' + pid] === undefined) return ({
      "pace": ls_player[pid].points,
  ...
  for (var key in ls_rosters) {
    if (ls_rosters.hasOwnProperty(key)) {
      ...
      if (ls_rosters[key].hasOwnProperty("S")) {
        for (var i = 0; i < ls_rosters[key].S.length; i++) {
          ...
          if (ls_orig_proj_when_final && _return_ar.game_sec_remaining === 0) {
            ...
            if ((_return_ar.pace - _return_ar.projected) < 0) jQuery(".pfpts_" + ls_rosters[key].S[i]).addClass('ls_below_projected');
            else if ((_return_ar.pace - _return_ar.projected) > 0) jQuery(".pfpts_" + ls_rosters[key].S[i]).addClass('ls_above_projected');
          } else if ((_return_ar.pace - _return_ar.projected) < 0) jQuery("#ls_pace_pts_" + ls_rosters[key].S[i]).html('<span class="ls_below_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
          else if ((_return_ar.pace - _return_ar.projected) > 0) jQuery("#ls_pace_pts_" + ls_rosters[key].S[i]).html('<span class="ls_above_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
          else jQuery("#ls_pace_pts_" + ls_rosters[key].S[i]).html('<span class="ls_at_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
        }
      }
      if (ls_orig_proj_when_final && _gsr === 0) {
        ...
        if ((_pace - _proj) < 0) jQuery(".ogffpts_" + key + ", #ogffpts_" + key + ", #fspts_" + key).addClass('ls_below_projected');
        else if ((_pace - _proj) > 0) jQuery(".ogffpts_" + key + ", #ogffpts_" + key + ", #fspts_" + key).addClass('ls_above_projected');
      ...
      if (ls_rosters[key].hasOwnProperty("NS")) {
        for (var i = 0; i < ls_rosters[key].NS.length; i++) {
          ...
          } else if ((_return_ar.pace - _return_ar.projected) < 0) jQuery("#ls_pace_pts_" + ls_rosters[key].NS[i]).html('<span class="ls_below_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
          else if ((_return_ar.pace - _return_ar.projected) > 0) jQuery("#ls_pace_pts_" + ls_rosters[key].NS[i]).html('<span class="ls_above_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
          else jQuery("#ls_pace_pts_" + ls_rosters[key].NS[i]).html('<span class="ls_at_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
        }
      }
      if (ls_orig_proj_when_final && _gsr === 0) {
        jQuery("#ls_pace_frpts_" + key).html('<span class="ls_projected" title="Original Projection">' + format_points(_proj) + '</span>');
        if ((_pace - _proj) < 0) jQuery("#frpts_" + key).addClass('ls_below_projected');
        else if ((_pace - _proj) > 0) jQuery("#frpts_" + key).addClass('ls_above_projected');
      } else if ((_pace - _proj) < 0) jQuery("#ls_pace_frpts_" + key).html('<span class="ls_below_projected" title="Original Projection: ' + format_points(_proj) + '">' + format_points(_pace) + '</span>');
      else if ((_pace - _proj) > 0) jQuery("#ls_pace_frpts_" + key).html('<span class="ls_above_projected" title="Original Projection: ' + format_points(_proj) + '">' + format_points(_pace) + '</span>');
      else jQuery("#ls_pace_frpts_" + key).html('<span class="ls_at_projected" title="Original Projection: ' + format_points(_proj) + '">' + format_points(_pace) + '</span>');
      ...
      if (ls_rosters[key].hasOwnProperty("IR")) {
        for (var i = 0; i < ls_rosters[key].IR.length; i++) {
          ...
          if (ls_orig_proj_when_final && _return_ar.game_sec_remaining === 0) {
            ...
            if ((_return_ar.pace - _return_ar.projected) < 0) jQuery(".pfpts_" + ls_rosters[key].IR[i]).addClass('ls_below_projected');
            else if ((_return_ar.pace - _return_ar.projected) > 0) jQuery(".pfpts_" + ls_rosters[key].IR[i]).addClass('ls_above_projected');
          } else if ((_return_ar.pace - _return_ar.projected) < 0) jQuery("#ls_pace_pts_" + ls_rosters[key].IR[i]).html('<span class="ls_below_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
          else if ((_return_ar.pace - _return_ar.projected) > 0) jQuery("#ls_pace_pts_" + ls_rosters[key].IR[i]).html('<span class="ls_above_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
          else jQuery("#ls_pace_pts_" + ls_rosters[key].IR[i]).html('<span class="ls_at_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
        }
      }
      ...
      if (ls_rosters[key].hasOwnProperty("TS")) {
        for (var i = 0; i < ls_rosters[key].TS.length; i++) {
          ...
          if (ls_orig_proj_when_final && _return_ar.game_sec_remaining === 0) {
            ...
            if ((_return_ar.pace - _return_ar.projected) < 0) jQuery(".pfpts_" + ls_rosters[key].TS[i]).addClass('ls_below_projected');
            else if ((_return_ar.pace - _return_ar.projected) > 0) jQuery(".pfpts_" + ls_rosters[key].TS[i]).addClass('ls_above_projected');
          } else if ((_return_ar.pace - _return_ar.projected) < 0) jQuery("#ls_pace_pts_" + ls_rosters[key].TS[i]).html('<span class="ls_below_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
          else if ((_return_ar.pace - _return_ar.projected) > 0) jQuery("#ls_pace_pts_" + ls_rosters[key].TS[i]).html('<span class="ls_above_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
          else jQuery("#ls_pace_pts_" + ls_rosters[key].TS[i]).html('<span class="ls_at_projected" title="Original Projection: ' + format_points(parseFloat(_return_ar.projected)) + '">' + _return_ar.formatted + '</span>');
        }
      }
    }
  }
    ...
    jQuery("#roster_away tr, #roster_home tr").each(function() {
      if ($(this).find("th").length > 0) {
        ...
        try {
          ...
          if (_id === undefined) $(this).find("td.ls_game_info").after('<td class="ls_projections' + _td_pad + '"' + _style + '></td>');
          else $(this).find("td.ls_game_info").after('<td class="ls_projections ffpts_pace_total' + _td_pad + '"' + _style + ' id="ls_pace_' + _id + '"></td>');
        }
      }
    });
  }
...
function ls_parse_projections() {
  ...
  $.ajax({
    type: 'GET',
    url: baseURLDynamic + "/" + year + "/export?TYPE=projectedScores&L=" + league_id + "&W=" + liveScoringWeek + "&JSON=1",
    async: false
...
function ls_navbar() {
  ...
  if (location.href.indexOf("W=") === -1) var _liveScoringWeek = liveScoringWeek;
  else var _liveScoringWeek = parseInt(location.href.substr(location.href.indexOf("W=") + 2, 2));
  for (var i = 1; i <= 17; i++) {
    if (i < liveScoringWeek) html += '<a href="#week' + i + '" onclick="location.href=\'' + baseURLDynamic + '/' + year + '/ajax_ls?L=' + league_id + '&W=' + _liveScoringWeek + '&W2=' + i + '\';"> ' + i + ' </a>';
    else if (i === liveScoringWeek) html += '<span class="currentweek"> ' + i + ' </span>';
    else if (i <= _liveScoringWeek) html += '<a href="#week' + i + '" onclick="location.href=\'' + baseURLDynamic + '/' + year + '/ajax_ls?L=' + league_id + '&W=' + _liveScoringWeek + '&W2=' + i + '\';"> ' + i + ' </a>';
    else html += '<a href="#week' + i + '" class="inactive" style="cursor:default"> ' + i + ' </a>';
  }
  html += '</span>';
  ...
  for (var i = 1; i <= 17; i++) {
    if (i < liveScoringWeek) html += '<option value="' + i + '">' + i + '</option>';
    else if (i === liveScoringWeek) html += '<option value="' + i + '" selected="selected">' + i + '</option>';
    else if (i <= _liveScoringWeek) html += '<option value="' + i + '">' + i + '</option>';
  }
  html += '</select>';
  html += '</span>';
  html += '</div>';
...
function ls_update_week() {
  ...
  ls_nfl_games = [];
  var url = baseURLDynamic + "/" + year + "/export?TYPE=nflByeWeeks&W=" + liveScoringWeek + "&JSON=1&rand=" + Math.random();
  $.ajax({
    type: 'GET',
    url: url,
    async: false
  ...
  var url = baseURLDynamic + "/" + year + "/export?TYPE=nflSchedule&W=" + liveScoringWeek + "&JSON=1&rand=" + Math.random();
  $.ajax({
    type: 'GET',
    url: url,
    async: false
  ...
  var _homeTeam = "";
  var _missingPlayers = "";
  var url = baseURLDynamic + "/" + year + "/export?TYPE=weeklyResults&L=" + league_id + "&W=" + liveScoringWeek + "&DETAILS=1&JSON=1&rand=" + Math.random();
  $.ajax({
    type: 'GET',
    url: url,
    async: false
...
if (document.getElementById("body_ajax_ls")) {
  ...
  jQuery('#ls_setting_drop .ls_toggle_settings').click(function() {
    $(".ls_append_input").slideToggle('500');
  });
  // Toggle class when player stats not selected to remove padding
  jQuery('input[name="hide_stats"]').click(function() {
  ...
  jQuery('#LS_AwayTeamName,#LS_AwayTeamRecord,#LS_AwayScore').click(function() {
  ...
  jQuery('#LS_HomeTeamName,#LS_HomeTeamRecord,#LS_HomeScore').click(function() {
  ...
  jQuery("#ls-modal-container").click(function() {
    $("#ls-modal-container").css('display', 'none');
  });
  jQuery("#ls-modal-container-2").click(function() {
    $("#ls-modal-container-2").css('display', 'none');
  });
  jQuery(".ls-modal-content").click(function(e) {
    e.stopPropagation();
  });
